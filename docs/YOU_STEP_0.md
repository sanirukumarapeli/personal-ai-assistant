...
|---|---|---|---|
| **`gemini-3.5-flash-lite`** (default) | **15** | **500** | Best: same headroom as 3.1 Lite, newer model |
...
**Fix:** set `GEMINI_MODEL_ID=gemini-3.5-flash-lite`, restart the API, try again.
